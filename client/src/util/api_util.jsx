...
export function isCurrentUser(user_id) {
...
export function getAllUserSkillPosts(user_skill_id, page) {
  return axios.get("/api/user_skills/" + user_skill_id + "/posts", {
    headers: {
...
export function getAllHomePosts(page) {
